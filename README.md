...
get the app created:
    ...
    $ heroku apps:create sillybot
    Creating sillybot... done, stack is cedar
    http://sillybot.herokuapp.com/ | git@heroku.com:sillybot.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://sillybot.herokuapp.com deployed to Heroku

    To git@heroku.com:sillybot.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://sillybot.herokuap.com
    ["Hello" :from Heroku]
